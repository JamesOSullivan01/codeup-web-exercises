...
cheeses.push('Carolina Ghost Pepper');
    ...
    // // let reversedCheeses = cheeses // creates an alias for the original array (
    //
    ...
    let removedKraft = cheeses.splice(cheeses.indexOf("Kraft American Singles"),1);
